...
export class UserTargetsComponent implements OnInit {
  ...
  get canCreate(): boolean {
    return this.authService.hasAnyPermission(['target_access', 'target_users_access_create', 'target_users_access_edit']);
  }

  get canEdit(): boolean {
    return this.authService.hasAnyPermission(['target_access', 'target_users_access_edit']);
  }

  get canDelete(): boolean {
    return this.authService.hasAnyPermission(['target_access', 'target_users_access_delete']);
  }

  get canUpload(): boolean {
    return this.authService.hasAnyPermission(['target_access', 'sales_target_users_upload']);
  }

  get canExport(): boolean {
    return this.authService.hasAnyPermission(['target_access', 'sales_target_users_download']);
  }

  get canTemplate(): boolean {
    return this.authService.hasAnyPermission(['target_access', 'sales_target_users_template']);
  }
